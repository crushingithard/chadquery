...
test("chadQuery.param()", function() {
	...
	equal( chadQuery.param(params), "someName%5B%5D=1&someName%5B%5D=2&someName%5B%5D=3&regularThing=blah", "with array" );
	...
	params = {"someName": [1, 2, 3], "regularThing": "blah" };
	equal( chadQuery.param(params), "someName=1&someName=2&someName=3&regularThing=blah", "with array" );
